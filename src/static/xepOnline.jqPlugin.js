...
xepOnline.Formatter = {
	...
	: 'http://xep.cloudformatter.com/Chandra.svc/genpackage',
	: 'http://xep.cloudformatter.com/Chandra.svc/genfile',
	_page_images: 'http://xep.cloudformatter.com/Chandra.svc/genpageimages',
	...
	*/
	__format: function(ElementIDs, options) {
		...
		if(options.render === 'download') {
			jQuery('body').append('<form style="width:0px; height:0px; overflow:hidden" enctype=\'multipart/form-data\' id=\'temp_post\' method=\'POST\' action=\'' + xepOnline.Formatter. + '\'></form>');
...
'<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" \
    ...
    <SOAP-ENV:Body> \
        <fairy:format SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"> \
			...
			jQuery.ajax({
				type: "POST",
				url: current_mimetype == "image/png" || current_mimetype == "image/jpg" || current_mimetype == "image/gif" ? xepOnline.Formatter._page_images : xepOnline.Formatter.,
				processData: false,
				contentType: false,
				data: blob,
